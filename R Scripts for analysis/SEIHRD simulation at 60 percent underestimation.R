# Based on 60% under-diagnosis, beta = 0.3862863
...
points(sg_data$date, total_60, col='green', pch = "*", lty = 1)
lines(sg_data$date, total_60, col = 'green', lty = 2)