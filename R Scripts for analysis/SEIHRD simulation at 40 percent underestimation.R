# Based on 40% under-diagnosis, beta = 0.3640641
...
points(sg_data$date, total_40, col='green', pch = "*", lty = 1)
lines(sg_data$date, total_40, col = 'green', lty = 2)