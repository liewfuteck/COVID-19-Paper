# for exponential trend, beta = 0.4381381
# new result: beta = 0.5635636

# alternatively, beta = 0.563964
...
# time intervals
time_1 <- seq(0,25,by=1)

sg_pop = 5.704 * 10^6

beta_value <- c(0.563964, 0.95 * 0.563964, (0.95^2) * 0.563964)
...
total_asymptomatic_exp = total_asymptomatic_1
...
lines(sg_data$date, total_asymptomatic_exp, col = 'blue', pch = '-', lty = 4)
lines(total_asymptomatic_exp, col = 'blue', lty = 4)
