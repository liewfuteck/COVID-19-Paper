# with no underestimation, beta = 0.3804805
...
total_asymptomatic_40pt = total_asymptomatic_1
...
par(mfrow = c(1,1))
plot(sg_data$date, sg_data$total_cases, col = 'red', pch = '*', lty = 1, xlab = "Date", ylab = "Cumulative Number of COVID-19 cases", ylim = c(0,5000))
lines(sg_data$total_cases, col = 'red', lty = 2)

lines(sg_data$date, total_asymptomatic_40pt, col='darkorchid', pch = "*", lty = 1)
lines(total_asymptomatic_40pt, col = 'darkorchid', lty = 2)
