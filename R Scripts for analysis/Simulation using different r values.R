...
total_asymptomatic_r_075 = total_asymptomatic_1
...
plot(sg_data$date, total_asymptomatic_r_026, col = "green", pch = "*", xlab = "Date", ylab = "Cumulative Number of COVID-19 cases", ylim = c(0,5000), lty = 1)
lines(sg_data$date, total_asymptomatic_r_026, col = "green", lty = 2)

points(sg_data$date, total_asymptomatic_r_058, col='blue', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_r_058, col = 'blue', lty = 2)

points(sg_data$date, total_asymptomatic_r_063, col='black', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_r_063, col = 'black', lty = 2)

points(sg_data$date, total_asymptomatic_r_075, col='darkorchid', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_r_075, col = 'darkorchid', lty = 2)
...
# Plotting of effective reproduction number for r
