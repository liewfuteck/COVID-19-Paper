...
beta_value <- c(0.3966967, 0.95 * 0.3966967, (0.95^2) * 0.3966967)
...
total_asymptomatic_20pt = total_asymptomatic_1
...
plot(sg_data$date, total_asymptomatic_20pt, col = "green", pch = "*", xlab = "Date", ylab = "Cumulative Number of COVID-19 cases", ylim = c(0,5000), lty = 1)
lines(sg_data$date, total_asymptomatic_20pt, col = "green", lty = 2)

points(sg_data$date, total_asymptomatic_40pt, col='blue', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_40pt, col = 'blue', lty = 2)

points(sg_data$date, total_asymptomatic_60pt, col='black', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_60pt, col = 'black', lty = 2)

points(sg_data$date, total_asymptomatic_exp, col='darkorchid', pch = "*", lty = 1)
lines(sg_data$date, total_asymptomatic_exp, col = 'darkorchid', lty = 2)

points(sg_data$date, sg_data$total_cases, col='red', pch = "*", lty = 1)
lines(sg_data$date, sg_data$total_cases, col = 'red', lty = 1)

legend("topleft", legend = c("20 percent asymptomatic cases; \u03B2 = 0.40", 
                             "40 percent asymptomatic cases; \u03B2 = 0.42",
                             "60 percent asymptomatic cases; \u03B2 = 0.44",
                             "Exponential trend; \u03B2 = 0.56", 
